$(function(){
	...
	$('#photo_submit').click(function(){
		...
		//파일 전송
		let form_data = new FormData(); //파일 정보 저장할 변수 선언
		form_data.append('photo',my_photo) //파일 정보를 보냄
		$.ajax({
